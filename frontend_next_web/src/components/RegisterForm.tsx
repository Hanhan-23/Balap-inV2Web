                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4">
                                    <Label htmlFor="name" className="w-32 text-right">Nama</Label>
                                    <Input
                                        id="name"
                                        name="nama_lengkap"
                                        type="text"
                                ...
                                <div className="flex items-center gap-4">
                                    <Label htmlFor="employeeId" className="w-32 text-right">ID Pegawai</Label>
                                    <Input
                                        id="employeeId"
                                        name="no_pegawai"
                                        type="number"
                                ...
                                <div className="flex items-center gap-4">
                                    <Label htmlFor="phone" className="w-32 text-right">Telepon</Label>
                                    <Input
                                        id="phone"
                                        type="tel"
                                        name="no_telp"
                                ...
                                <div className="flex items-start gap-4">
                                    <Label htmlFor="address" className="w-32 text-right pt-2">Alamat</Label>
                                    <Textarea
                                        id="address"
                                        name="alamat"
                                        className="max-w-sm w-full"
                            ...
                            <div className="text-center text-sm">
                                <div className="text-muted-foreground flex justify-center gap-1">
                                    ...
                                    <a href="/main/dashboard" className="underline underline-offset-4 text-blue-600 hover:text-blue-800">Masuk</a>
                                </div>
                            </div>
                        </div>
                    </form>
