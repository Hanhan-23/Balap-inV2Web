...
export default function Page() {
  ...
  const filteredData = data.filter((item) =>
    ...
    item.deskripsi_pengaduan.toLowerCase().includes(search.toLowerCase()) ||
    item.cuaca.toLowerCase().includes(search.toLowerCase()) ||
    item.nilai_kerusakan.toLowerCase().includes(search.toLowerCase()) ||
