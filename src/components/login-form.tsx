      ...
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-center text-sm">
                <div className="text-muted-foreground flex justify-center gap-1">
                  ...
                  <a href="/regis" className="underline underline-offset-4 text-blue-600 hover:text-blue-800">
                    Daftar
                  </a>
                </div>
              </div>
          ...
          <div className="bg-muted relative hidden md:block">
            <img src="/login.png" alt="Image" className="absolute inset-0 h-full w-full object-contain dark:brightness-[0.2] dark:grayscale"/>
          </div>
        </CardContent>
      </Card>
    </div>
